...
file_path <- "D:/MA2003B_Metodos_Multivariados/reto/datos/08_december_datasets/NORTE2_2020_2023.csv"
...
```{r}
#Ajuste del modelo
model =glm(Class~ PM10+RH+NO2, family="binomial", data=train)
...
### PM10
```{r}
boxTidwell(logodds~PM10,data=train)
```

### NO2
```{r}
boxTidwell(logodds~NO2,data=train)
```

# 8. Corrplot
```{r}
dataselect <- data[c("RH","NO2","PM10","PM2.5")]
