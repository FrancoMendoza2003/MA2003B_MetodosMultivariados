...
file_path <- "D:/MA2003B_Metodos_Multivariados/reto/datos/08_december_datasets/CENTRO_2020_2023.csv"
...
```{r}
#Ajuste del modelo
model =glm(Class~PM10+RH+WDR, family="binomial", data=train)
...
# 8. Corrplot
```{r}
dataselect <- data[c("RH","WSR","PM10","PM2.5")]
